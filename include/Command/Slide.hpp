...
namespace prog {
    namespace command {
        ...
        private:
            int x_offset_; // Número de pixeis a deslizar circularmente para a direita (horizontalmente)
            int y_offset_; // Número de pixeis a deslizar circularmente para baixo (verticalmente)
        };
    }
}
#endif //SLIDE_HPP
